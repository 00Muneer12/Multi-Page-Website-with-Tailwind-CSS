...
const About: React.FC = () => (
    <div
        ...
        style={{ backgroundImage: "url('/your-background-image.jpg')" }} // Replace with your image path
    >
        <header className="py-10 bg-[#1a237e] bg-opacity-90 text-white text-center">
        ...
        <section className="py-20 px-6 max-w-3xl mx-auto text-center bg-slate-200 bg-opacity-90">
